...
import { CodexDevelopmentPlanningCapability } from '../../../../../src/adapters/outbound/capabilities/development-planning/codex-development-planning-capability.ts';
...
if (!prompt.includes('Read-only inspection of the supplied snapshot files')) process.exit(23);
if (!prompt.includes('Approved snapshot paths:\\n- src/feature.ts')) process.exit(24);
